    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('📡 Channel', url='https://t.me/Team_Tamil_HD'),
                    InlineKeyboardButton('Movies 📽️', url='https://t.me/Tamil_HD_M0VIES')
                ],
                [
                    
                    InlineKeyboardButton('⭕ Devloper ⭕', url='https://t.me/AttitudeKing_vj')
                ]
            ]
        ),
